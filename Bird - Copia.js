class Bird {
    ...
    Acceleration() {
        if (this.CheckMates()) {
            this.acc = this.acc.Add(this.Alignment().Mul(0.5))
            this.acc = this.acc.Add(this.Separation().Mul(0.5))
            this.acc = this.acc.Add(this.Cohesion().Mul(0.5))
            this.acc = this.acc.Add(this.FleeObstacle().Mul(5 * 0.0))
        }
        else {
